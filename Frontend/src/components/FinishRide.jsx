    ...
    <>
      <div className="flex flex-col justify-between h-full">
        <div>
          ...
          <h2 className="text-xl sm:text-2xl font-semibold mb-4 sm:mb-6">Finish this Ride Here</h2>
        ...
        <div className="p-1">
          <button
            ...
            className="bg-green-600 w-full block text-center text-white p-3 text-base sm:text-xl font-medium mt-3 rounded-lg active:scale-95 transition-transform"
          >
            Finish Ride
          </button>
